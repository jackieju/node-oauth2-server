...
AuthorizeHandler.prototype.handle = function(request, response) {
  ...
  if ('false' === request.query.allowed) {
    ...
    console.log("====>2:"+JSON.stringify(request.user));
...
AuthorizeHandler.prototype.getClient = function(request) {
  ...
  if (!is.vschar(clientId)) {
    throw new InvalidRequestError('Invalid parameter: `client_id`');
      ...
      console.log("===>rdirecturi11:"+request.body.redirect_uri);
      console.log("===>rdirecturi111:"+request.query.redirect_uri);

  var redirectUri = request.body.redirect_uri || request.query.redirect_uri;
      console.log("===>rdirecturi1:"+redirectUri);
  ...
  return promisify(this.model.getClient, 2)(clientId, null)
    .then(function(client) {
      ...
      console.log("===>rdirecturi:"+redirectUri);
...
AuthorizeHandler.prototype.getResponseType = function(request) {
  ...
  console.log("===>responseTypes:"+JSON.stringify(responseTypes));
