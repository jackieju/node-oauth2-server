...
console.log("===>credentials:"+credentials+", grantType:"+grantType);
  if (credentials) {
    return { clientId: credentials.name, clientSecret: credentials.pass };
  }
console.log("===>client_id:"+request.body.client_id+", client_secret:"+request.body.client_secret);
...
TokenHandler.prototype.handleGrantType = function(request, client) {
  ...
  if (!grantType && request.body.response_type == 'token') {
      grantType = 'implicit';
  }
  if (!grantType) {
